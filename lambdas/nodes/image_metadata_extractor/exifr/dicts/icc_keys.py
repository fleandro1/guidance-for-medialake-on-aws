"""
ICC tag name translations

Maps ICC profile numeric offsets and 4-character codes to human-readable names.

Reference: https://exiftool.org/TagNames/ICC_Profile.html
"""
...
def load_icc_keys():
    """Load ICC tag key translations into global registry"""

    icc_keys = {
        # Header Tags (numeric offsets)
        4: "ProfileCMMType",
        8: "ProfileVersion",
        12: "ProfileClass",
        16: "ColorSpaceData",
